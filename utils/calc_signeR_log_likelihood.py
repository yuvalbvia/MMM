...
f = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../data/results/signeR/ehat_signeR.csv'))
data = csv.reader(f)
...
f = open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../data/results/signeR/phat_signeR.csv'))
normalized_E_matrix = []
emat = csv.reader(f)
firstline=True
for row in emat:
    ...
    for x in row:
        newList.append(float(x) / float(norm))
    normalized_E_matrix.append(newList)
f.close()
...
input = json.loads(open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../data/test_data.json')).read())
